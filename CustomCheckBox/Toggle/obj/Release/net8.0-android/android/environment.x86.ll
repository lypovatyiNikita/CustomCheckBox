...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 131898482, ; hash 0x7dc9c72, from name: Toggle.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 446871281, ; hash 0x1aa2b6f1, from name: libaot-Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 47
	...
	%struct.DSOCacheEntry {
		i64 866517365, ; hash 0x33a60175, from name: aot-Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	...
	%struct.DSOCacheEntry {
		i64 1043704058, ; hash 0x3e35a8fa, from name: Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	...
	%struct.DSOCacheEntry {
		i64 3070231048, ; hash 0xb7000208, from name: aot-Toggle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 357
	...
	%struct.DSOCacheEntry {
		i64 3612278663, ; hash 0xd74eff87, from name: libaot-Toggle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 407
