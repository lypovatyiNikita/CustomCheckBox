...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 707293845416888302, ; hash 0x9d0d00147e4c7ee, from name: Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 826379764117234338, ; hash 0xb77e40461c762a2, from name: libaot-Toggle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 23
	...
	%struct.DSOCacheEntry {
		i64 2685070155390796740, ; hash 0x25434914891243c4, from name: aot-Toggle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 71
	...
	%struct.DSOCacheEntry {
		i64 6188595721077963644, ; hash 0x55e24f050d5abb7c, from name: libaot-Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	...
	%struct.DSOCacheEntry {
		i64 14723636235116865779, ; hash 0xcc54dd258c35e8f3, from name: Toggle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 382
	...
	%struct.DSOCacheEntry {
		i64 15212525814865011218, ; hash 0xd31dbfa1137d2212, from name: aot-Toggle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Toggle.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
...
@.env.3 = private unnamed_addr constant [37 x i8] c"49e54c1f-a667-40c9-8874-b6ca75262973\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.toggle\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-Toggle.dll.so\00", align 16
